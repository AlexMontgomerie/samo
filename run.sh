...
function run_hls4ml {
    ...
    # build the hardware
    python -m scripts.build_hls4ml --model-path models/${network}.keras --config-path outputs/saved/${network}_${N}_hls4ml.json --platform platforms/${platform}.json --output-path outputs/lenet_hls4ml_prj | tee outputs/saved/${network}_${N}_hls4ml.txt
}

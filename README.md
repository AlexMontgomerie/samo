...
The usage of the SAMO tool can be seen by running `python -m samo --help`. Example platform configurations are given in the `platforms` directory. Example CNN models can be generated by running `python scripts/generate_networks.py`.
